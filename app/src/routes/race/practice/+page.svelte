...
<div class="flex flex-col items-center gap-12 w-300 h-content bg-stone-700 rounded-3xl p-8">
    ...
    <button class="flex justify-center items-center w-64 mt-8 font-semibold text-stone-50 text-4xl bg-emerald-600 pl-8 pr-8 pt-4 pb-4 rounded-full hover:bg-emerald-500"
